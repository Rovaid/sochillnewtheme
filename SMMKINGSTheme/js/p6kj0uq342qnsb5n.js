...
run: function(e) {
if ($(document).on("click", ".alert .close", function(e) {
...
window.localStorage && window.localStorage.setItem ? setTimeout(function e() {
...
a.amountCurrencyOptions = e.amountCurrencyOptions, a.params = e;
try {
...
void 0 !== e.options.paghiper && a.initPaghiper(e.options.paghiper), void 0 !== e.options.sumup && a.initSumup(e.options.sumup), 
void 0 !== e.options.stcpay && a.initStcPay(e.options.stcpay), void 0 !== e.options.geidea && a.initGeidea(e.options.geidea)), 
...
var n = $("#qr-modal"), a = i.fieldsContainer.serializeArray();
return a.push({
name: "save",
value: 1
}), $.ajax({
...
success: function(e) {
if ($("#qr-modal-spinner").hide(), "success" == e.status) {
n.modal("show"), n.on("hide.bs.modal", function() {
$("#qr-modal").remove(), window.location.reload();
});
var t = $("#qr-code-image"), a = $("#qr-code-value");
...
initGeidea: function(i) {
var n = this, o = function() {
$(".alert.alert-danger", n.fieldsContainer).remove();
}, r = function(e) {
o(), e && e.length && n.fieldsContainer.prepend(templates["addfunds/alert"]({
text: e
}));
};
$("button", n.fieldsContainer).on("click", function(e) {
...
window.location.reload();
}, o = new GeideaApi(e.data.merchant_key, t, a, n);
return o.configurePayment(e.data.payload), o.startPayment(), console.log(e.data.payload), 
!1;
}
if ("error" == e.status) return r(e.error && e.error.length ? e.error : i.defaultErrorText), 
!1;
}
}), !1;
});
...
o.updateFields(t, !0, n), o.updateDescription(), o.updateQuantityHelpBlock(), o.updateAverageTime();
...
o.updateCharge(), o.updateDescription(), o.updateAverageTime(), o.updateQuantityHelpBlock(), 
...
var e = $("#orderform-service"), t = this.services[e.val()], a = $("#field-orderform-fields-average_time");
a.addClass("hidden"), void 0 !== t && "string" == typeof t.average_time && t.average_time.length && (a.val(t.average_time), 
